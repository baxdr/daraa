    ...
    <main className="relative min-h-screen">
      ...
      <section className="mx-auto mt-16 max-w-xl px-6 md:mt-24 md:px-10">
        ...
        <p className="mt-4 max-w-md text-base leading-relaxed text-ink-2 md:text-lg">
          أدخل بريدك الإلكتروني — نستعرض لك مشاريعك المحفوظة وتقدر ترجع
          لنفس الداشبورد بلا ما تعيد من البداية.
        </p>
        ...
        <p className="mt-10 text-xs text-muted">
          ما لديك مشروع بعد؟{' '}
          <Link href="/chat" className="underline decoration-rule decoration-2 underline-offset-4 hover:decoration-accent hover:text-ink">
            ابدأ الآن ←
          </Link>
        </p>
      </section>
