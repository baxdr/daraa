const PROBLEMS = [
  'تجديدات تفوت بدون تذكير',
  'انتهاء رخصة = إغلاق فوري + غرامات',
  'فحوصات مفاجئة (طفايات، تهوية، شهادات صحية)',
  'لوحة محل غير معتمدة = مخالفة فورية',
  'متابعة يدوية لـ ٧+ جهات',
];

const SOLUTIONS = [
  'تذكير بالإيميل قبل ٧ و ٣ أيام من كل تجديد',
  'فحص حالة كل رخصة في ثوانٍ',
  'قائمة مخالفات محتملة + إجراءات حل',
  'تنبيه فوري على لوحة المحل والإعلانات',
  'كل الجهات في مكان واحد',
];
